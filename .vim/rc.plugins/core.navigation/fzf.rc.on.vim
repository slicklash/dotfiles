if InitStep() == 0
  ...
  call dein#add('junegunn/fzf', { 'rev': 'c65d11bfb5eda2fbf117bddb4512a04cca48d840', 'build': './install --all', 'merged': 0 })
  call dein#add('junegunn/fzf.vim', { 'rev': '8ea9574b3ebdc44fbe3dc6381a13f9ce0c290e2f', 'depends': 'fzf' })
  finish
endif
