if InitStep() == 0
  ...
  call dein#add('junegunn/fzf', { 'rev': '3b68dcdd81394f1ac9f743e1f74ff754f95eef9e', 'build': './install --all', 'merged': 0 })
  call dein#add('junegunn/fzf.vim', { 'rev': '98dcd77a189a8a87052c20d1be8082aea60101b7', 'depends': 'fzf' })
  finish
endif
