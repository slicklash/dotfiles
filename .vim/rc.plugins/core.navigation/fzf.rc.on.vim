...
call dein#add('junegunn/fzf', { 'rev': '55d5b153e627784fa43982fa3c01d0ab86ef0224', 'build': './install --bin', 'merged': 0 })
call dein#add('junegunn/fzf.vim', { 'rev': '34a564c81f36047f50e593c1656f4580ff75ccca', 'depends': 'fzf' })
