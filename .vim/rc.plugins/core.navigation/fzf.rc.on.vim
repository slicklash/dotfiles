if InitStep() == 0
  ...
  call dein#add('junegunn/fzf', { 'rev': '3db63f5e52ebf88a483558cbdfa4143fb84e41d0', 'build': './install --all', 'merged': 0 })
  " call dein#add('junegunn/fzf', { 'rev': '3db63f5e52ebf88a483558cbdfa4143fb84e41d0' })
