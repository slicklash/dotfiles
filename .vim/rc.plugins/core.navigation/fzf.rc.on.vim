if InitStep() == 0
  ...
  call dein#add('junegunn/fzf', { 'rev': '66df24040fed3c76df545fc34b47387c86922786', 'build': './install --all', 'merged': 0 })
  call dein#add('junegunn/fzf.vim', { 'rev': '3cb44a8ba588e1ada409af495bdc6a4d2d37d5da', 'depends': 'fzf' })
  finish
endif
