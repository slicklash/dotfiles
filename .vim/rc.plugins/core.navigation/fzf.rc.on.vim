if InitStep() == 0
  ...
  call dein#add('junegunn/fzf', { 'rev': '51fdaad002a5ad827bd5ebfac43386592005d02c', 'build': './install --all', 'merged': 0 })
  call dein#add('junegunn/fzf.vim', { 'rev': 'c311c0a95fc2529c26ab36a8f530e9dd4426304c', 'depends': 'fzf' })
  finish
endif
