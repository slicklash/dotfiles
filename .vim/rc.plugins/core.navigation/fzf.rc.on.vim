if InitStep() == 0
  ...
  call dein#add('junegunn/fzf', { 'rev': 'f97d2754134607b24849fc4a2062dbfcaafddd6a', 'build': './install --all', 'merged': 0 })
  call dein#add('junegunn/fzf.vim', { 'rev': '45d96c9cb1213204479593236dfabf911ff15443', 'depends': 'fzf' })
  finish
endif
